...
-- Insert sample game turns (10 days starting from today)
...
(1, DATE_ADD(CURDATE(), INTERVAL 0 DAY) + INTERVAL 0 HOUR, 
     DATE_ADD(CURDATE(), INTERVAL 1 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 0 DAY) + INTERVAL 20 HOUR, 'completed'),
(2, DATE_ADD(CURDATE(), INTERVAL 1 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 2 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 1 DAY) + INTERVAL 20 HOUR, 'completed'),
(3, DATE_ADD(CURDATE(), INTERVAL 2 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 3 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 2 DAY) + INTERVAL 20 HOUR, 'completed'),
(4, DATE_ADD(CURDATE(), INTERVAL 3 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 4 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 3 DAY) + INTERVAL 20 HOUR, 'completed'),
(5, DATE_ADD(CURDATE(), INTERVAL 4 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 5 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 4 DAY) + INTERVAL 20 HOUR, 'completed'),
(6, DATE_ADD(CURDATE(), INTERVAL 5 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 6 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 5 DAY) + INTERVAL 20 HOUR, 'completed'),
(7, DATE_ADD(CURDATE(), INTERVAL 6 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 7 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 6 DAY) + INTERVAL 20 HOUR, 'completed'),
(8, DATE_ADD(CURDATE(), INTERVAL 7 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 8 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 7 DAY) + INTERVAL 20 HOUR, 'completed'),
(9, DATE_ADD(CURDATE(), INTERVAL 8 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 9 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 8 DAY) + INTERVAL 20 HOUR, 'completed'),
(10, DATE_ADD(CURDATE(), INTERVAL 9 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 10 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 9 DAY) + INTERVAL 20 HOUR, 'completed'),
(11, DATE_ADD(CURDATE(), INTERVAL 10 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 11 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 10 DAY) + INTERVAL 20 HOUR, 'active'),
(12, DATE_ADD(CURDATE(), INTERVAL 11 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 12 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 11 DAY) + INTERVAL 20 HOUR, 'pending'),
(13, DATE_ADD(CURDATE(), INTERVAL 12 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 13 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 12 DAY) + INTERVAL 20 HOUR, 'pending'),
(14, DATE_ADD(CURDATE(), INTERVAL 13 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 14 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 13 DAY) + INTERVAL 20 HOUR, 'pending'),
(15, DATE_ADD(CURDATE(), INTERVAL 14 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 15 DAY) + INTERVAL 0 HOUR,
     DATE_ADD(CURDATE(), INTERVAL 14 DAY) + INTERVAL 20 HOUR, 'pending');
